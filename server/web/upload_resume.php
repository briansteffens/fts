	...
	Response:
		{
			...
			"file_id": [string], 	// The file's unique ID (in URL form)
			...
			"chunk_size": [int],	// Size in bytes of each chunk. Set by a previous /start			
		}
*/
...
$query = $mysqli->prepare("select id, chunk_size from files where file_hash = ? and date_created is null limit 1;");
